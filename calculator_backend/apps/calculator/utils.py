...
def analyze_image(image:Image, dictionary_of_vars: dict) :
    dict_of_vars_str = json.dumps(dictionary_of_vars, ensure_ascii=False)
    prompt = (
        ...
        f"PROPERLY QUOTE THE KEYS AND VALUES IN THE DICTIONARY FOR EASIER PARSING WITH Python's ast.literal_eval without any other keywords."
    )
    ...
    try:
        ...
        print(f"Errror in parsing response: {e}")
    print (answers)
